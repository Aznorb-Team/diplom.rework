                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-5 col-sm-9">
                                  <div class="input-group">
                                    <input class="datepicker-here form-control digits" type="text" data-language="en" data-bs-original-title="" title="" value="">
                                  </div>
                                </div>
                            </div>
                          </div>
                ...
                <form class="form theme-form" action='' method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        @switch($question->type)
                            @case(0)
                                <div class="form-outline border px-2 py-2">
                                    <label class="col-form-label" for="typeNumber">{{$number}}) {{$question->title}}</label>
                                    <div class="form-check">
                                        <input type="radio" name="flexRadioDefault{{$question->id}}" id="flexRadioDefault1{{$question->id}}" value="Yes" required>
                                        <label class="col-form-label" for="flexRadioDefault{{$question->id}}" name="yes">
                                        Да
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="flexRadioDefault{{$question->id}}" id="flexRadioDefault2{{$question->id}}" value="No" required>
                                        <label class="col-form-label" for="flexRadioDefault{{$question->id}}" name="no">
                                        Нет
                                        </label>
                                    </div>
                                </div>
                            ...
                            @case(1)
                                <div class="form-outline border px-2 py-2">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" name="text{{$question->id}}" id="floatingTextarea" required></textarea>
                            ...
                            @default
                                <div class="form-outline border px-2 py-2">
                                    <label class="col-form-label" for="typeNumber">{{$number}}) {{$question->title}}</label>
                                    <div class="form-check">
                                        <input type="radio" name="flexRadioDefault{{$question->id}}" id="flexRadioDefault1{{$question->id}}">
                                        <label class="col-form-label" for="flexRadioDefault1">
                                        Да
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="flexRadioDefault{{$question->id}}" id="flexRadioDefault2{{$question->id}}">
